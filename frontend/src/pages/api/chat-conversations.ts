...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.log('Chat conversations proxy: Forwarding request to:', `${baseUrl}${apiPath}`);
    console.log('Chat conversations proxy: Headers being sent:', {
    ...
    console.error('Chat conversations proxy error details:');
